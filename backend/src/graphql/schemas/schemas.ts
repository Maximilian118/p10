...
const Schema = buildSchema(`
  ...
  type rootMutation {
    ...
    updateChampSettings(_id: ID!, name: String, inviteOnly: Boolean, rounds: Int, maxCompetitors: Int, pointsStructure: [PointsStructureInput!], icon: String, profile_picture: String): Champ!
