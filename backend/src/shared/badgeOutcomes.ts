...
const badgeRewardOutcomes: badgeOutcomeType[] = [
  ...
  { name: "Double Down", awardedHow: "2 Win Streak", awardedDesc: "Win 2 rounds in a row.", rarity: 2 },
  ...
  { name: "Podium Streak", awardedHow: "Podium Streak x2", awardedDesc: "Finish on podium 2 rounds in a row.", rarity: 2 },
  ...
  { name: "Hat Trick", awardedHow: "3 Win Streak", awardedDesc: "Win 3 rounds in a row.", rarity: 3 },
  ...
  // New Rare badges.
  { name: "Contrarian", awardedHow: "Contrarian", awardedDesc: "Win when you're the only one who bet on your driver.", rarity: 3 },
  ...
  { name: "Quad Kill", awardedHow: "4 Win Streak", awardedDesc: "Win 4 rounds in a row.", rarity: 4 },
